...
if __name__ == "__main__":
    ...
    # Suspend stairs
    tg.AddSuspendStairs(init_pos=[-5.0, 0.0, 0.0], yaw=0.0, width=0.2, height=0.15, length=0.8, gap=0.13, stair_nums=6)
    ...
    # Perlin heigh field
    # tg.AddPerlinHeighField(position=[-6.0, 0.0, 0.0], size=[10.0, 10.0], height_scale=0.06, negative_height=0.06)
